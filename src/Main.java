...
public class Main {
    ...
    public static void main(String args[]) {
        ...
        p1.addTarefas(a1); // Adicionando a tarefa a1 ao projeto
        p1.addTarefas(a2); // Adicionando a tarefa a2 ao projeto
        p1.addTarefas(a3); // Adicionando a tarefa a3 ao projeto
